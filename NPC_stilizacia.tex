...
V svojej podstate ide len o jednoduchý If/Else algoritmus, pre ktorý je potrebné vopred vedieť čo má byť podmienka a čo sa má vykonať, ak je podmienka pravdivá alebo nepravdivá. 
...
\includegraphics[scale = 0.42]{MIP_NPC_latex.png}

{Obr. 1: Ukážka stromu rozhodovania}
